...
void PrintAnswer(BigNumber::CMegaNumber &number1, BigNumber::CMegaNumber &number2, BigNumber::CMegaNumber &answer, char oper, ofstream &writeStream)
{
	writeStream << number1.ToString() << " " << oper << " " << number2.ToString() << " = " << answer.ToString() << endl;
}
